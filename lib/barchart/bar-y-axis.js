...
export default class YAxis extends Component {
	...
	render( props ) {
		...
		return (
			<g>
				<line class={classNames("-chart-axis", "y-axis", props.class)} x1={width} y1={padBottom} x2={width} y2={100 - padTop} />
				{ShowTicks}
			</g>
		);
	}
